        ...
        <div className='h-[100vh] justify-center  '>
            <div className='w-[800px] h-[60vh] bg-gray-100 mx-auto mt-20 flex rounded-xl shadow-xl justify-between'>
                <div className='w-[50%] ml-[60px] mt-[100px]'>
                    <h2 className='text-4xl text-black font-semibold mb-4'>LogIn</h2>
                    ...
                    <p className='text-lg font-thin'>you don't have an account</p><Link className='text-md font-thin hover:underline' to='/signup'>SignUp</Link>
                </div>
